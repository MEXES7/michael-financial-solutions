...
const FEATURES = [
  {
    ...
    desc: "Set weekly or monthly deposits in minutes.",
  },
  {
    title: "Custom schedules",
    desc: "Adjust amounts and timing without penalties.",
  },
  {
    title: "Progress tracking",
    desc: "See your streaks and savings momentum.",
  },
];
    ...
    <main id="main-content" ref={containerRef}>
      ...
      <section className="py-16 text-center px-4 mt-10 bg-[#0056b3]">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold text-white">Scheduled Deposits</h1>
          <p className="mt-4 text-lg text-white">
            Automate deposits and keep savings moving without manual effort.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="mt-3 text-gray-600">
              Stay on track with routines that match your income cycle.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div data-animate>
            ...
            <p className="mt-4 text-lg text-gray-700">
              Set it once and let your savings build in the background.
            </p>
            <p className="mt-3 text-gray-600">
              Choose how much and how often to save, then adjust schedules
              anytime to match your goals.
            </p>
            <a
              href="/register"
          ...
          <div data-animate style={{ transitionDelay: "150ms" }}>
            <img
              src="/scheduled.jpg"
              alt="Planner and phone showing scheduled transfer reminders"
              loading="lazy"
