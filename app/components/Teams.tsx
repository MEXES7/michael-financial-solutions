        ...
        <div className="teams-grid">
          <div className="team-card animate-on-scroll">
            <div className="team-image">
              <img src="team-1.jpg" alt="James Anderson - CEO" />
            </div>
            <div className="team-info">
              <h3 className="team-name">James Anderson</h3>
              <p className="team-role">Chief Executive Officer</p>
              <p className="team-bio">
                20+ years of experience in global finance and banking
                leadership.
              </p>
          ...
          <div className="team-card animate-on-scroll">
            <div className="team-image">
              <img src="team-2.jpg" alt="Sarah Mitchell - CFO" />
            </div>
            <div className="team-info">
              <h3 className="team-name">Sarah Mitchell</h3>
              <p className="team-role">Chief Financial Officer</p>
              <p className="team-bio">
                Expert in financial strategy and risk management.
              </p>
              <div className="team-social">
                <a href="#" aria-label="LinkedIn">
                  <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="team-card animate-on-scroll">
            <div className="team-image">
              <img src="team-4.jpg" alt="Michael Chen - CTO" />
            </div>
            <div className="team-info">
              <h3 className="team-name">Michael Chen</h3>
              <p className="team-role">Chief Technology Officer</p>
              <p className="team-bio">
                Leading digital transformation and secure banking innovation.
              </p>
              <div className="team-social">
                <a href="#" aria-label="LinkedIn">
                  <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="team-card animate-on-scroll">
            <div className="team-image">
              <img src="team-3.jpg" alt="Emily Rodriguez - COO" />
            </div>
            <div className="team-info">
              <h3 className="team-name">Emily Rodriguez</h3>
              <p className="team-role">Chief Operations Officer</p>
              <p className="team-bio">
                Streamlining operations for exceptional customer experience.
              </p>
              <div className="team-social">
                <a href="#" aria-label="LinkedIn">
                  <svg viewBox="0 0 24 24" fill="currentColor">
